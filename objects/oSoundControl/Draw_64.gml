if (load && global.enableDebug) {
  ...
  draw_set_font(fnt);
  draw_text(0, 16, "#SOUNDCONTROL SETTINGS#");
  draw_text(0, 32, "PRESS + or - to switch groups.");
  draw_text(
    32,
    48,
    "PRESS VK_UP or VK_DOWN to adjust volume on current group."
  );
  draw_text(0, 64, "Loading default group: " + string(defaultSounds));
  draw_text(0, 80, "Loading soundtrack group: " + string(soundTrack));
  draw_text(
    0,
    96,
